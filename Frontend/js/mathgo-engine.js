...
export async function initEngine({
  ...
  function getIconHTML(iconStr) {
    ...
    const mapping = {
      ...
      "📦": '<i class="fa-solid fa-box" style="color:#8B2952;"></i>',
      ...
      "🔮": '<i class="fa-solid fa-wand-magic-sparkles" style="color:#8B2952;"></i>',
      ...
      "🎭": '<i class="fa-solid fa-masks-theater" style="color:#8B2952;"></i>',
      ...
      "🔭": '<i class="fa-solid fa-circle-nodes" style="color:#8B2952;"></i>',
